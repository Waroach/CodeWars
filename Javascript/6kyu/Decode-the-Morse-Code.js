function decodeMorse(morseCode) {
  ...
  return morseCode.split(' ')
              ...
              // PSEUDOCODE
// create a variable object named morse
  // set the object keys of morse code strings
  // set the object values to the corisponding outputs.
// split the morseCorde string into smaller sections using the three spaces
// take each smaller section and split them into the letters they represent
  // match the morse to the key and return the value form the object
// rejoin letters into words.
// rejoin words into a single string and return it.
...
he Morse code is case-insensitive, traditionally capital letters are used.
