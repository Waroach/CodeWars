...
middle digit(s) and the sum of all digits to the right of the middle digit(s) are equal*.
Task
...
balanced or not, e.g 413023 is a balanced number because the left sum and right sum are both 5.
